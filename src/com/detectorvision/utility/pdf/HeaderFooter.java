/* $Id: HeaderFooter.java 451 2013-01-26 08:28:29Z frank $ */
...
public class HeaderFooter extends PdfPageEventHelper {
	...
	// Logging with log4j
	static Logger logger = Logger.getLogger(HeaderFooter.class.getName());

	/**
	 * adds a Header and a Footer.
	 */
	public HeaderFooter() {
		int tableWidth=510;//table width in points
		ArrayList<String> footerArray=Footer.getInfo();
		...
		try {
			...
			//TODO clean up the code below - we are doing the same stuff 5 times ....
			...
			Paragraph p2 = new Paragraph("Krönleinstrasse 49",
					FontFactory.getFont(BaseFont.HELVETICA, BaseFont.WINANSI,
					BaseFont.NOT_EMBEDDED, 9));
